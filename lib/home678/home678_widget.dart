...
import 'home678_model.dart';
export 'home678_model.dart';

class Home678Widget extends StatefulWidget {
  const Home678Widget({super.key});

  @override
  State<Home678Widget> createState() => _Home678WidgetState();
}

class _Home678WidgetState extends State<Home678Widget>
    with TickerProviderStateMixin {
  late Home678Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Home678Model());
